...
$featurearray = array("Hoelang zal u hoofdpijn houden?" => array("Twee dagen","Vier dagen","Een week","Twee weken"),"Hoe groot is de klimaatimpact van de medicatie?" => array("Twee weken","Een maand","Twee maanden"),"Hoofdpijn (drie uur na het innemen)" => array("Ja","Nee"),"Hoe regelmatig moet u de medicatie nemen?" => array("Eenmalig","Een keer per dag voor drie dagen","Een keer per dag voor een week"),"Kosten van de medicatie" => array("10 euro","20 euro","40 euro"));

$restrictionarray = array(array(array("Hoelang zal u hoofdpijn houden?","Twee dagen"),array("Hoe groot is de klimaatimpact van de medicatie?","Twee weken")),array(array("Hoe groot is de klimaatimpact van de medicatie?","Twee maanden"),array("Hoelang zal u hoofdpijn houden?","Twee weken")),array());
